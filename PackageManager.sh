...
echo_info() { [[ $SILENT -eq 0 ]] && echo -e "${BLUE}[*] $*${X}"; }
echo_warn() { [[ $SILENT -eq 0 ]] && echo -e "${YELLOW}[-] $*${X}"; }
echo_success() { [[ $SILENT -eq 0 ]] && echo -e "${GREEN}[+] $*${X}"; }
echo_error() { echo -e "${RED}[!] $*${X}"; }
